...
interface IProps {
  ...
  plugin: 'rpm';
  repository: RPMRepositoryType;
  updateRepository: (r) => void;
}

export const RPMRepositoryForm = ({
  allowEditName,
  errorMessages,
  onCancel,
  onSave,
  ...
  return (
    <Form>
      ...
      {formGroup(
        'auto_publish',
        t`Auto-publish`,
        t`Automatically create publications for new repository versions, and update any distributions pointing to this repository.`,
        <Checkbox
          id='autopublish'
          isChecked={repository.autopublish}
          label={t`Enable auto-publish`}
          onChange={(_event, value) =>
