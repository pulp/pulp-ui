describe('collection tests', () => {
  ...
  it('deletes an entire collection', () => {
    cy.go(`repo/published/test_namespace/test_collection`);
  ...
  it('deletes a collection version', () => {
    ...
    cy.get(`a[href*="repo/published/my_namespace/my_collection"]`).click();
    cy.openHeaderKebab();
  ...
  it('should copy collection version to validated repository', () => {
    ...
    cy.go(`repo/published/${namespace}/${collection}`);
  ...
  it('deletes a collection from repository', () => {
    cy.go(`collections?view_type=list`);
  ...
  it('deletes a collection version from repository', () => {
    ...
    cy.go(
      `repo/repo2/test_namespace/test_repo_collection_version2/?version=1.0.0`,
    );
    ...
    cy.go(
      `repo/published/test_namespace/test_repo_collection_version2/?version=1.0.0`,
    );
